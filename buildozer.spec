...
# (str) Package name
package.name = imagecolorpickerapp
...
requirements = python3,kivy, kivymd==1.2.0, pillow==12.0.0, plyer
...
android.permissions = android.permission.READ_EXTERNAL_STORAGE, android.permission.WRITE_EXTERNAL_STORAGE, android.permission.INTERNET, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18)
